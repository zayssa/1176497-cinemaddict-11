export const createFilmDetailesModalTemplate = (film) => {
      ...
      <form class="film-details__inner" action="" method="get">
        <div class="form-details__top-container">
            ...
            <div class="film-details__info">
              <div class="film-details__info-head">
                <div class="film-details__title-wrap">
                  ...
                  <p class="film-details__title-original">Original: ${film.original}</p>
                </div>
          ...
          <section class="film-details__controls">
            ...
            <input type="checkbox" class="film-details__control-input visually-hidden" id="watched" name="watched" ${film.history ? `checked` : ``}>
            <label for="watched" class="film-details__control-label film-details__control-label--watched">Already watched</label>

            <input type="checkbox" class="film-details__control-input visually-hidden" id="favorite" name="favorite" ${film.farorite ? `checked` : ``}>
